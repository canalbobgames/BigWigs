...
L.textDesc = "Se deve mostrar ou ocultar o texto exibido nas barras."
L.icon = "ícone"
...
L.visibleBarLimitDesc = "Selecione o máxido de barras que serão visiveis ao mesmo tempo."
...
L.disableSfx = "Desabilita efeitos de som"
L.disableSfxDesc = "A opção 'Efeitos de Som' nas opções de som do WoW serão desligadas, então religadas quando o encontro de chefe acabar. Isso pode te ajudar a manter o foco em avisos de som do BigWigs." 
L.blockTooltipQuests = "Bloqueia a barra de ajuda de missões e objetivos"
L.blockTooltipQuestsDesc = "Quando você precisa matar um chefe para um missão, normalmente vai mostrar '0/1 completo' na barra de ajuda quando você posicionar o cursos em cima do chefe. Isso irá ficar escondido enquanto em combate com o chefe para prevenir que a barra de ajuda fique muito grande."
L.blockObjectiveTracker = "Esconde o rastreador de missões"
L.blockObjectiveTrackerDesc = "O rastreador de missões ficará escondido durante um encontro com chefe para limpar o espaço na tela."
...
L.red = "Vermelho"
L.redDesc = "Avisos gerais de encontros."
L.blue = "Azul"
L.blueDesc = "Aviso para coisas que lhe afetam diretamente como debuffs sendo aplicados em você."
L.orange = "Laranja"
L.yellow = "Amarelo"
L.green = "Verde"
L.greenDesc = "Avisos para coisas boas, como debuff sendo removidos de você."
L.cyan = "Ciano"
L.cyanDesc = "Avisos para encontros em que o status mudou, como avançar para a próxima estágio."
L.purple = "Roxo"
L.purpleDesc = "Avisos específicos para habilidades de tanks, como stacks de um debuff de tank."
